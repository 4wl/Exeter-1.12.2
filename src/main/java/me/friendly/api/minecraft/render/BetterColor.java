...
public class BetterColor extends Color {
	...
	public final static BetterColor getRainbow(double rainbowOffset, float rainbowSpeed, float separation) {
		final double speed = ((50 - rainbowSpeed) + 1) * 100;
		float hue = (float) ((System.currentTimeMillis() + (rainbowOffset * separation)) % speed);
		hue /= speed;
